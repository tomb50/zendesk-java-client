...
/**
 * Created with IntelliJ IDEA. User: tombeadman Date: 21/10/14 Time: 18:00
 */
public class IncrementalTicket
{
    ...
    private String url;
    private Long reqExternalId; //hmm
    ...
    public void setGeneratedTimestamp( final Long generatedTimestamp )
    {
    ...
    public void setResolutionTime( final Long resolutionTime )
    {
    ...
    public Long getReqExternalId()
    {
      return reqExternalId;
    }

    public void setReqExternalId( final Long reqExternalId )
    {
